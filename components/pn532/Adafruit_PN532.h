...
class Adafruit_PN532{
 public:
  Adafruit_PN532(gpio_num_t clk, gpio_num_t miso, gpio_num_t mosi, gpio_num_t ss);  // Software SPI
  Adafruit_PN532(gpio_num_t irq, gpio_num_t reset);  // Hardware I2C
  Adafruit_PN532(gpio_num_t ss);  // Hardware SPI
  void begin(void);
 ...
 private:
  gpio_num_t _ss, _clk, _mosi, _miso;
  gpio_num_t _irq, _reset;
